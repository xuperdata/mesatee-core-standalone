...
use mesatee_core::ipc::protos::ecall::{RunUnitTestInput, RunUnitTestOutput};
...
fn test_from_unstrusted() {
    unit_tests!(
        mesatee_core::tests::test_error,
        teaclave_config::tests::test_runtime_config,
        teaclave_config::tests::test_build_config,
    );
}
